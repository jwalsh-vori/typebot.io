...
import { cometChatBlock } from "@typebot.io/comet-chat-block";
import { cometChatBlockSchema } from "@typebot.io/comet-chat-block/schemas";
...
export const forgedBlockSchemas = {
  ...
  [cometChatBlock.id]: cometChatBlockSchema,
} as const;
